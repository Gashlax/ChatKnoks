...
public class CreateChatRoom {
	...
	private void initialize() {
		...
		createBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(gNameArea.getText().equals("")||gNameArea.getText().equals("Enter a Group Name:")) {
					...
					statusLbl.setText("Not a valid name for Group Chat");
				}else {
					createChatRoom(gNameArea.getText());
					Name=gNameArea.getText();
					addFirstUser(UserId);
					statusLbl.setText("Group Chat Created");
				}
		...
		statusLbl.setBounds(111, 206, 255, 14);
		frmCreateGroup.getContentPane().add(statusLbl);
	}
